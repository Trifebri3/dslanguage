        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-ds-light p-8 border border-gray-100 hover:shadow-lg transition duration-300 flex flex-col h-full group">
                    ...
                    <a href="#" class="text-[#C0A062] text-xs font-bold uppercase tracking-widest group-hover:text-yellow-600 transition mt-auto">German Language Program &rarr;</a>
                </div>
                ...
                <div class="bg-ds-light p-8 border border-gray-100 hover:shadow-lg transition duration-300 flex flex-col h-full group">
                    ...
                    <a href="#" class="text-[#C0A062] text-xs font-bold uppercase tracking-widest group-hover:text-yellow-600 transition mt-auto">Ausbildung &rarr;</a>
                </div>
                ...
                <div class="bg-ds-light p-8 border border-gray-100 hover:shadow-lg transition duration-300 flex flex-col h-full group">
                    ...
                    <a href="#" class="text-[#C0A062] text-xs font-bold uppercase tracking-widest group-hover:text-yellow-600 transition mt-auto">Study in Germany &rarr;</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="border-t border-gray-200 pt-10">
                ...
                <div class="flex flex-wrap justify-center gap-4 text-xs font-bold uppercase tracking-wide">
                    <a href="/employer-readiness" class="text-[#324338] hover:text-[#C0A062] transition">Employer Readiness</a>
                    <span class="text-gray-300">|</span>
                    <a href="/about" class="text-[#324338] hover:text-[#C0A062] transition">About</a>
                </div>
            </div>
        </div>
    </section>
