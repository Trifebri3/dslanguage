        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="border-t border-gray-200 pt-10">
                ...
                <div class="flex flex-wrap justify-center gap-4 text-xs font-bold uppercase tracking-wide">
                    <a href="{{ route('employer.international-talent') }}" class="text-[#324338] hover:text-[#C0A062] transition">International Talent</a>
                    <span class="text-gray-300">|</span>
                    <a href="{{ route('employer.index') }}" class="text-[#324338] hover:text-[#C0A062] transition">How It Works (Employer Readiness)</a>
                    <span class="text-gray-300">|</span>
