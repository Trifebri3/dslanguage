        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="border-t border-gray-200 pt-10">
                ...
                <div class="flex flex-wrap justify-center gap-4 text-xs font-bold uppercase tracking-wide">
                    <a href="#" class="text-[#324338] hover:text-[#C0A062] transition">Language Readiness</a>
                    <span class="text-gray-300">|</span>
                    <a href="#" class="text-[#324338] hover:text-[#C0A062] transition">Cultural & Workplace Readiness</a>
                    <span class="text-gray-300">|</span>
